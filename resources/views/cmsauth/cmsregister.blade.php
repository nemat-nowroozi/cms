...
<body class="hold-transition register-page">
    ...
    <div class="register-box">
        ...
        <div class="register-box-body">
            ...
            <form action="{{route('cms.register')}}" method="post">
                @csrf
            ...
            <div class="social-auth-links text-center">
                <p>- یا -</p>
                <a href="#" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> ثبت
                    نام با فیسبوک</a>
                <a href="#" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> ثبت
                    نام با گوگل</a>
            </div>
